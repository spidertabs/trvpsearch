...
CREATE TABLE course_results (
  ...
  grade ENUM('A', 'B+', 'B-', 'C+', 'C-', 'D+', 'D-', 'F', 'NA') NOT NULL,
  status ENUM('NA','Passed', 'TBD', 'Redo') NOT NULL,
  primary key (result_id)
);


INSERT INTO students (phoneNumber, avatar, fullname, sex, regNo, school, programme, email, password, activation) VALUES
(0712345678, 'avatar1.jpg', 'Kofi Owusu', 'Male', '2022-08-22245', 'omac', 'dit', 'kofiowusu@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0723456789, 'avatar2.jpg', 'Nneoma Okoro', 'Female', '2022-08-22246', 'omac', 'dit', 'nneomaokoro@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0734567890, 'avatar3.jpg', 'Abdulai Jalloh', 'Male', '2022-08-22247', 'omac', 'bit', 'abdulaijalloh@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0745678901, 'avatar4.jpg', 'Akua Asante', 'Female', '2022-08-22248', 'omac', 'bit', 'akuasante@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),

(0756789012, 'avatar5.jpg', 'Tunde Ogunbiyi', 'Male', '2022-08-22249', 'omac', 'dcs', 'tundeogunbiyi@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0767890123, 'avatar6.jpg', 'Nadia Sow', 'Female', '2022-08-22250', 'omac', 'dcs', 'nadiasow@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0734567890, 'avatar13.jpg', 'Nana Yaa Amponsah', 'Female', '2022-08-22257', 'omac', 'bcs', 'nanayaamponsah@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0745678901, 'avatar14.jpg', 'Kofi Agyapong', 'Male', '2022-08-22258', 'omac', 'bcs', 'kofiagyapong@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),

(0778901234, 'avatar7.jpg', 'Kwame Boateng', 'Male', '2022-08-22251', 'onas', 'dic', 'kwameboateng@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0789012345, 'avatar8.jpg', 'Fatoumata Diallo', 'Female', '2022-08-22252', 'onas', 'dic', 'fatoumatadiallo@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0712345678, 'avatar11.jpg', 'Oluwaseun Adeyemi', 'Male', '2022-08-22255', 'onas', 'bic', 'oluwaseunadeyemi@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0723456789, 'avatar12.jpg', 'Aisha Mohammed', 'Female', '2022-08-22256', 'onas', 'bic', 'aishamohammed@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),

(0790123456, 'avatar9.jpg', 'Emmanuel Mensah', 'Male', '2022-08-22253', 'economics', 'dstat', 'emmanuelmensah@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0701234567, 'avatar10.jpg', 'Yaa Agyeman', 'Female', '2022-08-22254', 'economics', 'dstat', 'yaaagyeman@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0756789012, 'avatar15.jpg', 'Fatima Jallow', 'Female', '2022-08-22259', 'economics', 'bstat', 'fatimajallow@yahoo.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes'),
(0767890123, 'avatar16.jpg', 'Ebenezer Osei', 'Male', '2022-08-22260', 'economics', 'bstat', 'ebenezerosei@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Yes');

INSERT INTO lecturers (l_code, l_avatar, l_name, gender, mobile) VALUES
('101', 'male.png', 'Dr. Kwame Owusu', 'Male', '0712345678'),
('102', 'female.png', 'Dr. Nneoma Okoro', 'Female', '0723456789'),
('103', 'male.png', 'Dr. Abdulai Jalloh', 'Male', '0734567890'),
('104', 'female.png', 'Dr. Akua Asante', 'Female', '0745678901'),
('105', 'male.png', 'Dr. Tunde Ogunbiyi', 'Male', '0756789012'),
('106', 'female.png', 'Dr. Nadia Sow', 'Female', '0767890123'),
('107', 'male.png', 'Dr. Kwame Boateng', 'Male', '0778901234'),
('108', 'female.png', 'Dr. Fatoumata Diallo', 'Female', '0789012345'),
('109', 'male.png', 'Dr. Emmanuel Mensah', 'Male', '0790123456'),
('110', 'female.png', 'Dr. Yaa Agyeman', 'Female', '0701234567'),
('111', 'male.png', 'Dr. Oluwaseun Adeyemi', 'Male', '0712345678'),
('112', 'female.png', 'Dr. Aisha Mohammed', 'Female', '0723456789'),
('113', 'female.png', 'Dr. Nana Yaa Amponsah', 'Female', '0734567890'),
('114', 'male.png', 'Dr. Kofi Agyapong', 'Male', '0745678901'),
('115', 'female.png', 'Dr. Fatima Jallow', 'Female', '0756789012'),
('116', 'male.png', 'Dr. Ebenezer Osei', 'Male', '0767890123'),
('117', 'female.png', 'Dr. Ama Appiah', 'Female', '0778901234'),
('118', 'male.png', 'Dr. Joseph Mensah', 'Male', '0789012345'),
('119', 'female.png', 'Dr. Rachel Osei', 'Female', '0790123456'),
('120', 'male.png', 'Dr. Christopher Owusu', 'Male', '0701234567'),
('121', 'female.png', 'Dr. Hannah Asante', 'Female', '0712345678'),
('122', 'male.png', 'Dr. Michael Agyemang', 'Male', '0723456789'),
('123', 'female.png', 'Dr. Emmanuela Osei', 'Female', '0734567890'),
('124', 'male.png', 'Dr. Richard Boateng', 'Male', '0745678901'),
('125', 'female.png', 'Dr. Patricia Appiah', 'Female', '0756789012'),
('126', 'male.png', 'Dr. Daniel Ofori', 'Male', '0767890123'),
('127', 'female.png', 'Dr. Sophia Amoako', 'Female', '0778901234'),
('128', 'male.png', 'Dr. Joseph Mensah', 'Male', '0789012345'),
('129', 'female.png', 'Dr. Rachel Osei', 'Female', '0790123456'),
('130', 'male.png', 'Dr. Christopher Owusu', 'Male', '0701234567'),
('131', 'female.png', 'Dr. Georgina Asante', 'Female', '0712345678'),
('132', 'male.png', 'Dr. Benjamin Agyemang', 'Male', '0723456789'),
('133', 'female.png', 'Dr. Evelyn Osei', 'Female', '0734567890'),
('134', 'male.png', 'Dr. Francis Boateng', 'Male', '0745678901'),
('135', 'female.png', 'Dr. Diana Appiah', 'Female', '0756789012'),
('136', 'male.png', 'Dr. Gabriel Ofori', 'Male', '0767890123');



INSERT INTO courses (l_code, course_code, course_title, dit, bit, dcs, bcs, bic, dic, dstat, bstat, year, semester) VALUES
...
INSERT INTO course_results (regNo, course_code, grade, status) VALUES
